...
def lambda_handler(event, context):
    section_a = "" # Horizontal Field to be returned. (Outcome of this field will depend on if we have the credits to reverse geocode)
    ...
    if(response.status_code == 200): #Do we still have credits for today? 
        ...
        message_a = response["features"][0]["properties"]["city"]+"\'s Local Gems"
